...
<? foreach($arResult["ITEMS"] as $arItem):?>
    ...
    <div class="col-lg-6 col-sm-6 col-xs-6 col-md-6 del-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
        <div class="col-lg-3 col-sm-3 col-xs-12 col-md-3 padding_left_right_none">
            <a href="<?php echo $arItem['DISPLAY_PROPERTIES']['download_file_pdf']['FILE_VALUE']['SRC'];?>" download="<?php echo $arItem['DISPLAY_PROPERTIES']['download_file_pdf']['FILE_VALUE']['ORIGINAL_NAME'];?>">
                <img
